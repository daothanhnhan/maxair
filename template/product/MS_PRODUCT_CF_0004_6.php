    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="item_sp">
            <div class="product-item">
                <!--BOX SALE-->
                <div class="item-img"> <a href="/<?= $rowLang['friendly_url'] ?>">
                <div class="sale_pt">
                <?= $item['product_price_sale'] ?>%
                <p class="giam-sale">Giảm</p></div>
                <img
                ...
                <div class="item-text">
                    ...
                    <div class="action_product_banhatgiong row">
                        ...
                        <div class=" model__edit my-width-1-3@lg my-width-1-2@md" data-id="12" data="modal-<?= $d3 ?>">
                        ...
                        <div class="modal fade bs-example-modal-lg in" id="modal-<?= $d3 ?>" tabindex="-1" role="dialog"
                            aria-hidden="true">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <?php include DIR_CART."MS_CART_BANHATGIONG_0002_2.php";?></div>
                    </div>
                </div>
