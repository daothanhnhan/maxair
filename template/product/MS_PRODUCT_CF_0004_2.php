...
$product_promotions = $product_type->getProductList_byMultiLevel_orderProductId(233,'desc','','4','');//var_dump($rows);
                ...
                <div class="header-sale">
                    <div class="row flash-sale-header-with-countdown-timer__wrapper--with-horizontal-line-decorators">
                            ...
                            <div class="contdown_sale">
                                <i class="fa fa-clock-o" aria-hidden="true"></i> Kết thúc trong <span id="hour"></span>
                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class=" row tab-pane fade in " id="tab2default">
                            ...
                            <?php                      
                                ...
                                foreach ($product_new as $item) { 
                                    ...
                                    $row1 = $product_type->getProductDetail_byId($item['product_id'], $lang);                        
                                    ?>
                            <?php include DIR_PRODUCT."MS_PRODUCT_CF_0004_4.php";?>
                            <?php } ?>
                        </div>
                        <!--SALE 16:00-->
                        <div class="row tab-pane fade in" id="tab3default">
                            ...
                            <?php                         
                            $d2=5;    foreach ($product_hot as $item) {   
                                $d2++;                          
                                $rowLang = $product_type->getProductLangDetail_byId($item['product_id'], $lang);                            
                                $row1 = $product_type->getProductDetail_byId($item['product_id'], $lang);                        
                                ?>
                            <?php include DIR_PRODUCT."MS_PRODUCT_CF_0004_5.php";?>
                            <?php } ?>
                        </div>
                        <!--SALE 20:00-->
                        <div class=" row tab-pane fade in" id="tab4default">
                            <?php                         
                            $d3=7;    foreach ($product_sale as $item) {   $d3++;                          $rowLang = $product_type->getProductLangDetail_byId($item['product_id'], $lang);                            $row1 = $product_type->getProductDetail_byId($item['product_id'], $lang);                        ?>
                            <?php include DIR_PRODUCT."MS_PRODUCT_CF_0004_6.php";?>
                            <?php } ?>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    var x = setInterval(function () {
        ...
        document.getElementById("hour").innerHTML = '<span class="gio">' + days + ' ngày </span>' +
            ...
            '<span class="gio">' + minutes + '</span>'+'<span class="gio-giac">' + ':' + '</span>' + '<span class="gio">' + seconds + '</span>';
