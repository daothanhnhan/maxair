            ...
            <div class="product-item">
                ...
                <div class="item-text">
                    ...
                    <div class="action_product_banhatgiong row">
                        ...
                        <div class=" model__edit my-width-1-3@lg my-width-1-2@md" data-id="12" data="modal-<?= $d1 ?>">
                        ...
                        <div class="modal fade bs-example-modal-lg in" id="modal-<?= $d1 ?>" tabindex="-1" role="dialog"
                            aria-hidden="true">
