<?php
    $list_slide = $action->getList('newscat', 'newscat_parent', '86', 'newscat_sort', 'asc', '', '', '');
...
<div class="container">
    <div id="tinh-nang" class="tinhnang">
        <div class="row slide-tinhnang owl-carousel owl-theme" style="">
            ...
            $video = $action->getList('news', 'newscat_id', $item['newscat_id'] ,'news_id', 'desc', '', $rowConfig['slide_num'], '');
