<div class="my-dathang">
    ...
    <div class=" model__edit my-width-1-3@lg my-width-1-2@md" data-id="12" data="modal-cart-main">
        ...
        <span class="add_cart_banhatgiong add_cart" name="add-to-cart" title="Thêm giỏ hàng" onclick="popup_cart('<?php echo $row1['product_id'];?>', '<?php echo $row1['product_name'];?>', 
	'<?php echo $row1['product_price_down']-$rowConfig['content_home8'];?>')">
        <?php } else { ?>
        <span class="add_cart_banhatgiong add_cart" name="add-to-cart" title="Thêm giỏ hàng" onclick="popup_cart('<?php echo $row1['product_id'];?>', '<?php echo $row1['product_name'];?>', 
    '<?php echo $row1['product_price_down'];?>')">
        <?php } ?>
            <i class="fa fa-shopping-bag1" aria-hidden="true">Mua Ngay</i>
