                                                ...
                                                <div class="woocommerce-billing-fields">
                                                    ...
                                                    <div class="woocommerce-billing-fields__field-wrapper">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <p class="form-row form-row-last" >
                                                                    ...
                                                                    <label class="">Họ tên <abbr class="required" title="required">*</abbr></label>

                                                                    <input type="text" class="input-text " name="txtName" id="inputTxtName"  placeholder="" value="<?= $row['user_name']?>" required="">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <p class="form-row form-row-last">
                                                                    ...
                                                                    <input type="tel" class="input-text" name="txtPhone" id="inputTxtPhone" placeholder="" value="<?= $row['user_phone']?>" required="">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <p class="form-row form-row-last">
                                                                    ...
                                                                    <input type="email" class="input-text" name="txtEmail" id="inputTxtEmail" placeholder="" value="<?= $row['user_email']?>" required="">
                                                        ...
                                                        <p class="form-row form-row-last">
                                                            ...
                                                            <input type="text" class="input-text" name="txtAddress" id="inputTxtAddress" placeholder="" value="<?= $row['user_address']?>" required="">
                                                    ...
                                                    <div id="order_review" class="woocommerce-checkout-review-order">
                                                        ...
                                                        <div class="vk-checkout-order-left">
                                                            ...
                                                            <div class="form-row place-order">
                                                                ...
                                                                <button type="submit" name="send_mail" class="btn btn-primary" id="submitPayment" style="padding:3px 30px; font-weight:bold; font-size:16px; margin-bottom:15px;background-color:#ff6131; border:1px solid #fff;" ><?php if($lang == "vn"){echo "Hoàn tất mua hàng";}else{echo "Complete Shopping";}?></button>

                                                                <?php } else { ?>

                                                                    <a href="/login" title="" style="padding: 10px;background-color:#ff6131;color:#fff;">Hãy đăng nhập để thanh toán</a>
