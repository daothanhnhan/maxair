<?php 
    $cart = $action->getList('cart', 'new', '0', 'id_cart', 'asc', '', '', '');
    $cart_count = count($cart);
?>
<div class="fixed_mobie">
    <div class="contentFL">
        <nav class="visible-sm visible-xs mobile-menu-container mobile-nav">
            ...
            <div class="menu-mobile-nav">
                ...
                <span class="text-meny icon-bar "><i>Quản lý chung<i></span>
            ...
            <div id="cssmenu" class="animated">
                ...
                <ul class="listMenuFL">
                    ...
                    echo 'sltMenu';
                    } ?>"><img src="image/manager2.png" class="iconMenu2" /><img src="image/manager.png"
                                class="iconMenu" />Quản
                            lí chung</a></li>

                    <!-- tab tài khoản -->
                    <li><a href="index.php?page=tai-khoan" title="" class="linkMenu <?php if ($_GET["page"] == 'tai-khoan' || $_GET["page"] == 'sua-tai-khoan' || $_GET["page"] == 'them-tai-khoan') {
                    echo 'sltMenu';
                        } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                                class="iconMenu" />Tài
                            khoản</a></li>

                    <!-- tab tài khoản user -->
                    <li><a href="index.php?page=tai-khoan-user" title="" class="linkMenu <?php if ($_GET["page"] == 'tai-khoan-user' || $_GET["page"] == 'sua-tai-khoan-user') {
                    echo 'sltMenu';
                    } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                                class="iconMenu" />Tài khoản
                            khách hàng</a></li>

                    <!-- tab bài viết -->
                    <li><a href="index.php?page=bai-viet" title="" class="linkMenu <?php if ($_GET["page"] == 'bai-viet' || $_GET["page"] == 'sua-bai-viet' || $_GET["page"] == 'them-bai-viet') {
                    echo 'sltMenu';
                    } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                                class="iconMenu" />Trang Page</a>
                    </li>

                    <!-- tab danh mục tin tức -->
                    <li><a href="index.php?page=danh-muc-tin-tuc" title="" class="linkMenu <?php if ($_GET["page"] == 'danh-muc-tin-tuc' || $_GET["page"] == 'sua-danh-muc-tin-tuc' || $_GET["page"] == 'them-danh-muc-tin-tuc') {
                    echo 'sltMenu';
                } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Danh
                            mục bài Post</a></li>

                    <!-- tab tin tức -->
                    <li><a href="index.php?page=tin-tuc" title="" class="linkMenu <?php if ($_GET["page"] == 'tin-tuc' || $_GET["page"] == 'them-tin-tuc' || $_GET["page"] == 'sua-tin-tuc') {
                     echo 'sltMenu';
                    } ?>"><img src="image/news2.png" class="iconMenu2" /><img src="image/news.png"
                                class="iconMenu" />Danh sách bài
                            Post</a></li>
                    ...
                    <li><a href="index.php?page=danh-muc-san-pham" title="" class="linkMenu <?php if ($_GET["page"] == 'danh-muc-san-pham' || $_GET["page"] == 'them-danh-muc-san-pham' || $_GET["page"] == 'sua-danh-muc-san-pham') {
                    echo 'sltMenu';
                    } ?>"><img src="image/product2.png" class="iconMenu2" /><img src="image/product.png"
                                class="iconMenu" />Danh mục
                            sản phẩm</a>
                    </li>

                    <!-- tab sản phẩm -->
                    <li><a href="index.php?page=san-pham" title="" class="linkMenu <?php if ($_GET["page"] == 'san-pham' || $_GET["page"] == 'them-san-pham' || $_GET["page"] == 'sua-san-pham') {
                    echo 'sltMenu';
                    } ?>"><img src="image/product2.png" class="iconMenu2" /><img src="image/product.png"
                                class="iconMenu" />Danh
                            sách sản phẩm</a></li>
                    ...
                    <!-- tab đặt hàng -->
                    <li><a href="index.php?page=don-hang" title="" class="linkMenu <?php if ($_GET["page"] == 'don-hang' || $_GET["page"] == 'them-don-hang' || $_GET["page"] == 'sua-don-hang') {
                        echo 'sltMenu';
                    ...
                    <!-- tab menu -->
                    <li><a href="index.php?page=trinh-don" title="" class="linkMenu <?php if ($_GET["page"] == 'trinh-don' || $_GET["page"] == 'them-trinh-don' || $_GET["page"] == 'sua-trinh-don') {
                    echo 'sltMenu';
                    } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                                class="iconMenu" />Menu</a>
                    </li>

                    <li><a href="index.php?page=lien-he" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Liên hệ</a>
                    </li>

                    <li><a href="index.php?page=danh-gia" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Đánh giá</a>
                    </li>

                    <!-- tab danh sach người dùng đăng ký -->
                    <li><a href="index.php?page=dang-ky" title="" class="linkMenu <?php if ($_GET["page"] == 'dang-ky' || $_GET["page"] == 'them-dang-ky' || $_GET["page"] == 'sua-dang-ky') {
                        echo 'sltMenu';
                    } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                                class="iconMenu" />Đăng ký nhận
                            tin</a></li>

                    <li><a href="index.php?page=tinh" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Tỉnh thành phố</a>
                    </li>

                    <li><a href="index.php?page=quan" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Quận huyện</a>
                    </li>

                    <li><a href="index.php?page=phuong" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Phường xã</a>
                    </li>

                    <li><a href="index.php?page=dai-ly" title=""
                   class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Đại lý</a>
                    </li>

                    <li><a href="index.php?page=thanh-pho" title=""
                           class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Thành phố đại lý</a>
                    </li>

                    <li><a href="index.php?page=quan-huyen" title=""
                           class="linkMenu "><img src="image/page2.png" class="iconMenu2"/><img src="image/page.png" class="iconMenu"/>Quận Huyện đại lý</a>
                    </li>
            
                    <li><a href="index.php?logout" title="" class="linkMenu "><img src="image/page2.png"
                                class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Đăng xuất</a>
                    </li>
        ...
        <ul class="listMenuFL">
            ...
            <li><a href="index.php?page=tai-khoan-user" title="" class="linkMenu <?php if ($_GET["page"] == 'tai-khoan-user' || $_GET["page"] == 'sua-tai-khoan-user') {
                       echo 'sltMenu';
                        ...
                        class="iconMenu" />Tài khoản khách hàng</a></li>

            <!-- tab bài viết -->
            <li><a href="index.php?page=bai-viet" title="" class="linkMenu <?php if ($_GET["page"] == 'bai-viet' || $_GET["page"] == 'sua-bai-viet' || $_GET["page"] == 'them-bai-viet') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png"
                        class="iconMenu" />Trang Page</a></li>
            ...
            <li><a href="index.php?page=tin-tuc" title="" class="linkMenu <?php if ($_GET["page"] == 'tin-tuc' || $_GET["page"] == 'them-tin-tuc' || $_GET["page"] == 'sua-tin-tuc') {
                       echo 'sltMenu';
                        ...
                        class="iconMenu" />Danh sách bài Post</a></li>
            ...
            <li><a href="index.php?page=don-hang" title="" class="linkMenu <?php if ($_GET["page"] == 'don-hang' || $_GET["page"] == 'them-don-hang' || $_GET["page"] == 'sua-don-hang') {
                       echo 'sltMenu';
                   } ?>"><img src="image/page.png" class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Đơn
                    hàng <?= $cart_count != 0 ? '('.$cart_count.')' : '' ?></a></li>

            <!-- tab cấu hình website -->
            <li><a href="index.php?page=config" title="" class="linkMenu <?php if ($_GET["page"] == 'config') {
                    echo 'sltMenu';
                } ?>"><img src="image/page2.png" class="iconMenu2" /><img src="image/page.png" class="iconMenu" />Cấu
                    hình
                    website</a></li>
            ...
            <li><a href="index.php?page=dang-ky" title="" class="linkMenu <?php if ($_GET["page"] == 'dang-ky' || $_GET["page"] == 'them-dang-ky' || $_GET["page"] == 'sua-dang-ky') {
                       echo 'sltMenu';
                        ...
                        class="iconMenu" />Đăng ký nhận tin</a></li>
...
<div class="fixedTop">
    ...
    <div style="float: right;margin-right: 300px;">
        <p class='titleFixedTop'>User: <?php echo (isset($_SESSION['admin_name']))?$_SESSION['admin_name']:"";?></p>
    </div>
</div>
<!--end fixedTop-->

<div class="logoTop">
    <a href="/" class="linkLogoTop"><img src="image/logo.png" class="imgLogoTop" /></a>
        ...
        (function ($) {
            ...
            $.fn.menumaker = function (options) {
                ...
                return this.each(function () {
                    ...
                    if (settings.sticky === true) cssmenu.css('position', 'inherit');
