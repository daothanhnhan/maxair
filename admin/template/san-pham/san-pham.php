                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                $procat = explode(",", $row['productcat_ar']);
                        ...
                        <td style="float: none;"><a href="index.php?page=xoa-san-pham&id=<?= $row['product_id'] ?>" style="float: none;" onclick="return confirm('Bạn có chắc muốn xóa.')">Xóa</a></td>
                        <?php } ?>
                    </tr>
                <?php
                }
