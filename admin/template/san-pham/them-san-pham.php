        ...
        <div class="boxNodeContentPage">
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent" >
                    ...
                    <p class="titleRightNCP">Thành tiền (VNĐ)</p>

                    <input type="number" class="txtNCP1" value="<?php echo $row['product_price_down'];?>" name="product_price_down"/>
            ...
            <div class="rowNCP">
                ...
                <div class="subColContent">
                    ...
                    <input type="number" class="txtNCP1" value="<?php echo $rowPro['product_payment'];?>" name="product_payment"/>
