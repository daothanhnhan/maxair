...
<form action="" method="post" enctype="multipart/form-data" id="updateConfig">
    ...
    <div class="rowNodeContentPage">
     ...
     <div class="rowNodeContentPage">
        <div class="leftNCP">
            <span class="titLeftNCP">logo footer</span>
            <p class="subLeftNCP">Thay logo footer cho website<br /><br /></p>                         
        </div>
        <div class="boxNodeContentPage">
            <div id="wrapper">
                ...
                <?php 
                    ...
                    ?>
                        <img src="../images/<?= $rowConfig['banner1']?>" class="img-responsive" alt="Image" style="width: 200px;">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Tài khoản</p>
            ...
            <p class="titleRightNCP">Thông tin</p>
            <textarea name="content_home7" id="input" class="form-control" rows="3"><?php echo $row_showMain['lang_content_home7']?></textarea>

            <p class="titleRightNCP">Số tiền giảm</p>
            <input type="number" class="txtNCP1" value="<?php echo $rowConfig['content_home8']?>" name="content_home8" required/>
            <!-- <textarea name="content_home8" id="input" class="form-control" rows="3"><?php echo $row_showMain['lang_content_home8']?></textarea> -->

            <p class="titleRightNCP">Thời gian chạy slide</p>
            <input type="number" class="txtNCP1" value="<?php echo $row_showMain['lang_content_home10']?>" name="content_home10"/>
            ...
            <p class="titleRightNCP">Số sản phẩm</p>
            <input type="number" class="txtNCP1" value="<?php echo $rowConfig['product_num']?>" name="product_num"/>

            <p class="titleRightNCP">Số sản phẩm flash</p>
            <input type="number" class="txtNCP1" value="<?php echo $rowConfig['product_flash_num']?>" name="product_flash_num"/>

            <p class="titleRightNCP">Số slide</p>
            <input type="number" class="txtNCP1" value="<?php echo $rowConfig['slide_num']?>" name="slide_num"/>

            <p class="titleRightNCP">Count down</p>
            <input type="date" class="txtNCP1" value="<?php echo $rowConfig['count_down']?>" name="count_down"/>

            <p class="titleRightNCP">Text giảm giá</p>
            <input type="text" class="txtNCP1" value="<?php echo $rowConfig['text']?>" name="text"/>
        </div>
    </div><!--end rowNodeContentPage-->
