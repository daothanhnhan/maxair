...
<div id="divWrapper">
    ...
    <div class="coverFormLogin">
        ...
        <p class="endLogin">CÔNG TY CỔ PHẦN TẬP ĐOÀN IMBB<br /><em style="text-decoration:underline;">Điện thoại:</em> <strong>086.886.6698</strong> - <em style="text-decoration:underline;">Email:</em> <strong>imbbgroup.company@gmail.com</strong><br /><em style="text-decoration:underline;">Website:</em>imbbgroup.com</p>
