...
class action_page extends library{
	...
	/*-------------- Cấu hình trang chủ --------------------*/
		...
		public function updateConfig(){
			...
			$product_num = isset($_POST['product_num']) ? $_POST['product_num'] : '0';

			$count_down = isset($_POST['count_down']) ? $_POST['count_down'] : '0000-00-00';

			$text = isset($_POST['text']) ? $_POST['text'] : '';

			$product_flash_num = isset($_POST['product_flash_num']) ? $_POST['product_flash_num'] : '0';

			$slide_num = isset($_POST['slide_num']) ? $_POST['slide_num'] : '0';
			...
			if (!$this->Update_1('config',
								  ...
								  'ssssssssssssssssssssiiissssssssi')) {
	...
	/*--------------- Danh mục sản phẩm -------------------*/
		...
		public function deleteProductCat(){
			...
			if ($productcat_id == 233 || $productcat_id == 234 || $productcat_id == 235 || $productcat_id == 236) {
	...
	/*--------------- Sản phẩm --------------------*/
		...
		public function addProduct(){
			...
			$product_price_down = isset($_POST['product_price_down']) ? $_POST['product_price_down'] : '0';
   ...
   //          }
	  ...
	  //   	if(isset($_FILES['fileUpload2']) && $_FILES['fileUpload2']['name'] != ""){
			...
			$insert = $this->Insert_1('product', 
									   ...
									   'sssssssdddsssisiiissssssssssssssssdissssi');
		...
		public function updateProduct(){
			...
			$product_price_down = isset($_POST['product_price_down']) ? $_POST['product_price_down'] : '';
   ...
   //          }
	...
	/*---------------- Danh mục tin tức --------------------*/
		...
		public function updateNewsCat(){
			...
			$newscat_sort = isset($_POST['newscat_sort']) ? $_POST['newscat_sort'] : '0';
