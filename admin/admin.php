        ...
        <div class="coverWeb">
            ...
            if (isset($_GET["page"])) {
                switch ($_GET["page"]) {
                    ...
                    case "xoa-bai-viet":
                        include_once("template/bai-viet/xoa-bai-viet.php");
                        break;
                    ...
                    case "xoa-tin-tuc":
                        include_once("template/tin-tuc/xoa-tin-tuc.php");
                        break;
                    ...
                    case "xoa-san-pham":
                        include_once("template/san-pham/xoa-san-pham.php");
                        break;
                    ...
                    // case thanh vien user/////////////////
                     case "tai-khoan-user":
                        ...
                        break;
                    case "user-cart":
                        include_once("template/tai-khoan-user/tai-khoan-user-cart.php");
                        break;
                    case "them-user":
                        include_once("template/tai-khoan-user/them-user.php");
                        break;
                    case "sua-user":
                        include_once("template/tai-khoan-user/sua-user.php");
                        break;
                    case "xoa-user":
                        include_once("template/tai-khoan-user/xoa-user.php");
                        break;
                    // ///////////////////////
                    ...
                    case "don-hang-ngay":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-don-hang.css' />";
                        include_once("template/don-hang/don-hang-ngay.php");
                        break;

                    case "don-hang-ngay-range":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-don-hang.css' />";
                        include_once("template/don-hang/don-hang-ngay-range.php");
                        break;

                    case "don-hang-state":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-don-hang.css' />";
                        include_once("template/don-hang/don-hang-state.php");
                        break;

                    case "don-hang-thang":
                        echo "<link rel='stylesheet' type='text/css' href='css/trang-don-hang.css' />";
                        include_once("template/don-hang/don-hang-thang.php");
                        break;

                    case "xoa-don-hang":
                        include_once("template/don-hang/xoa-don-hang.php");
                        break;
                    ...
                    ///////////// đánh giá ////////////////
                    case "danh-gia":
                        include_once("template/danh-gia/danh-gia.php");
                        break;
                    case "xoa-danh-gia":
                        include_once("template/danh-gia/xoa-danh-gia.php");
                        break;
                    ////////////// tinh ///////////////////
                    case "tinh":    
                        include_once("template/tinh/tinh.php");
                        break;
                    case "them-tinh":
                        include_once("template/tinh/them-tinh.php");
                        break;
                    case "sua-tinh":
                        include_once("template/tinh/sua-tinh.php");
                        break;
                    case "xoa-tinh":
                        include_once("template/tinh/xoa-tinh.php");
                        break;
                    /////////////// quan //////////////////
                    case "quan":
                        include_once("template/quan/quan.php");
                        break;
                    case "them-quan":
                        include_once("template/quan/them-quan.php");
                        break;
                    case "sua-quan":
                        include_once("template/quan/sua-quan.php");
                        break;
                    case "xoa-quan":
                        include_once("template/quan/xoa-quan.php");
                        break;
                    ////////////// phuong /////////////////
                    case "phuong":
                        include_once("template/phuong/phuong.php");
                        break;
                    case "them-phuong":
                        include_once("template/phuong/them-phuong.php");
                        break;
                    case "sua-phuong":
                        include_once("template/phuong/sua-phuong.php");
                        break;
                    case "xoa-phuong":
                        include_once("template/phuong/xoa-phuong.php");
                        break;
                    /////////// dai ly ////////////////
                    case "dai-ly":
                        include_once("template/dai-ly/dai-ly.php");
                        break;

                    case "them-dai-ly":
                        include_once("template/dai-ly/them-dai-ly.php");
                        break;

                    case "sua-dai-ly":
                        include_once("template/dai-ly/sua-dai-ly.php");
                        break;

                    case "xoa-dai-ly":
                        include_once("template/dai-ly/xoa-dai-ly.php");
                        break;
                    ////////////// thanh pho ///////////////
                    case "thanh-pho":
